...
#define DETECTION_MIN_SIGNAL_RATE_MCPS 0.0f
#define REQUIRED_NEAR_SAMPLES 1
#define REQUIRED_CLEAR_SAMPLES 3
#define SENSOR_COINCIDENCE_MS 300
#define CROSSING_LOCKOUT_MS 800
#define SENSOR_LONG_RANGE_MODE 0
#define SENSOR_SIGNAL_RATE_LIMIT_MCPS 0.10f
#define SENSOR_TIMING_BUDGET_US 33000
#define SENSOR_TELEMETRY_INTERVAL_MS 200
